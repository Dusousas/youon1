      ...
      <section id="main" className="customH py-10 bg">
        <div className="maxWidth flex flex-col h-full items-center gap-x-8 gap-y-10 md:gap-y-24 gap lg:flex-row">
          <article className="w-full lg:w-1/2">
            <h1 className="text-4xl text-center font-bold uppercase text-white lg:text-left lg:text-6xl">
              Site profissional para impulsionar o sucesso de sua empresa.
            </h1>
            <p className="mt-4 text-center font-normal text-white lg:text-left">
              Convertendo visitantes em clientes! Sites que fazem toda a
              diferença.
            </p>
